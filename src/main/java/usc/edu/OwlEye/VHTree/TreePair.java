...
public class TreePair {
    ...
    public DomNode merge(File file1, File file2) {
        XMLUtils xmlUtils1 = new XMLUtils(file1.getAbsolutePath());
        XMLUtils xmlUtils2 = new XMLUtils(file2.getAbsolutePath());
        DomNode root1 = xmlUtils1.readXML(file1.getAbsolutePath());
        DomNode root2 = xmlUtils2.readXML(file2.getAbsolutePath());
    ...
    public DomNode merge(String filePath1, String filePath2) {
        XMLUtils xmlUtils1 = new XMLUtils(filePath1);
        XMLUtils xmlUtils2 = new XMLUtils(filePath2);
        DomNode root1 = xmlUtils1.readXML(filePath1);
        DomNode root2 = xmlUtils2.readXML(filePath2);
