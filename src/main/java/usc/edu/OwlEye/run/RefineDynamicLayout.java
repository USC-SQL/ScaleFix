...
//        String ui_version_type = "largest_font";
        ...
        if (args.length > 0) {
            System.out.println("Dyanmic Layout To Refine: " + args[0]);
//            System.out.println("Activity: " + args[1]);
            ...
            activity="uk.co.yahoo.p1rpp.calendartrigger.activites.MainActivity";
            filePath="/home/aalotaib/OWlRepair/Subjects/yahoom/DynamicVH/Nexus_26P_29/DD/";
        }
...
//        String fullDynamicVHPath=String.format(dynamicVHPlaceHolder,ui_version_type);
        ...
        String dynamic_layouts_folder=filePath;
...
//                File.separator + subject+"/"+ui_version;
        ...
        for (File f : dynamicLayoutFolder.listFiles()) {
           ...
           // System.out.println("fileNamexx: " + fileName);
