...
public class WRGNode_OLD extends GraphNode {
    ...
    private HashMap<String,String> SiblingsIDWeightMap;




    public WRGNode_OLD(String xpath, String property, double ratio, double numerator, double denominator, double parentTotal) {
        super(xpath);
    ...
    public WRGNode_OLD(String xpath, Node<DomNode> xmlNode, String property, double ratio, double numerator, double denominator, double parentTotal) {
        super(xpath);
        this.property = property;
        this.ratio = ratio;
        this.numerator = numerator;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        WRGNode_OLD other = (WRGNode_OLD) obj;
        if (property == null) {
