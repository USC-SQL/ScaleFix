...
public class ElementWrapper implements Clusterable {
    ...
    private final Map<String, ArrayList<DomNode>> parentsWithFixedCSSValue;
...
//	}
	...
	*/
    ...
    public double distance(ElementWrapper elmB, XPathDistanceMeasurer xPathDistanceMeasurer) {
        ...
        featureWeights.put(HEIGHT, 0.1);//0.1
        featureWeights.put(WIDTH, 0.1);//0.1
...
//		String classA = this.getDomNode().getTagName();  // tagName currently contain the class name
