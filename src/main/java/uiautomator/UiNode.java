...
public class UiNode extends BasicTreeNode {
    ...
    public static String getID(UiNode temp) {
        String id_key = null;
        ...
        if (id_key != null) {
            String str = temp.getAttribute(id_key);
    ...
    public String getID() {
        ...
        if (this.getAttribute("resource-id") != null) {
            id_key = "resource-id";
        } else if (this.getAttribute("android:id") != null) {
            id_key = "android:id";
        } else {
            id_key = null;
        }
        ...
        if (id_key != null) {
            String str = this.getAttribute(id_key);
            int index = str.lastIndexOf('/');
            str = str.substring(index + 1);
